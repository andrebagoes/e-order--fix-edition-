...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center">PBLO</h4></li>
  ...
  <footer class="main-footer">    
	<marquee hspace="40" width="full-width">PBLO berhak menentukan barang apa saja yang disetujui atau tidak</marquee>
