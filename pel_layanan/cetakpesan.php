...
$query = mysqli_query($koneksi, "SELECT unit, tgl_permintaan, count(kode_brg)  FROM permintaan WHERE unit= '$_SESSION[username]' AND status=6  GROUP BY tgl_permintaan  ");
