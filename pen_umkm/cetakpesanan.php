...
<div class="isi" style="margin: 0 auto;">
  <table class="tabel2">
    ...
    <tbody>
      ...
      $query = mysqli_query($koneksi, "SELECT permintaan.nama_tukang, permintaan.kode_brg, unit, nama_brg, jumlah, satuan, harga_item, tgl_permintaan FROM permintaan INNER JOIN stokbarang ON permintaan.kode_brg = stokbarang.kode_brg  WHERE unit='$unit' AND  status=1 AND tgl_permintaan='$tgl' ");
      $i   = 1;
