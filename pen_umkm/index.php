...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center">Penyelia</h4></li>
  ...
  <footer class="main-footer">    
	<marquee hspace="40" width="full-width">Penyelia Unit Terkait Berhak menyetujui atau menolak permintaan barang</marquee>
