...
if (isset($_GET['id'])) {
	...
	$query1 = mysqli_query($koneksi, "UPDATE permintaan SET status=22 WHERE id_permintaan='$id' ");

	if ($query1) { 
		header("location:index.php?p=datapesanan");
		$chatid = "994886881";
		$text = "Hai, ini MumuM, ada permintaan barang dari unit SDM & UMUM yang membutuhkan persetujuan, silahkan cek di aplikasi e-Order";
