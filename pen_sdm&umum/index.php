...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center">Penyelia SDM & UMUM</h4></li>
  ...
  <footer class="main-footer">    
	<marquee hspace="40" width="full-width">Penyelia SDM & UMUM berhak menentukan permintaan barang yang akan di setujui</marquee>
